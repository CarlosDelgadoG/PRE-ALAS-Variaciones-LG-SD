...
* **Motivación de la investigación ** *¿De qué manera inciden los distintos contextos en que se desenvuelven las personas en las diferentes trayectorias de la sintomatología depresiva?*
...
* *SIS 2020:* Trastornos mentales es el único grupo diagnóstico que aumenta en el número de licencias tramitadas, en especial las de mediana y larga duración y en el grupo de mujeres entre 35 y 64.
...
* *Jimenez et. al 2020:* La **sintomatología depresiva** nos da un indicio del estrés sicosocial que afecta a una comunidad en un momento determinado. 
...
* Se coompone de siete Módulos (*Salud y Bienestar*).
